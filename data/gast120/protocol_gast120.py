...
root_path = './data/gast120/statistics'
setup_file = osp.join(root_path, 'setup.txt')
performer_file = osp.join(root_path, 'performer.txt')
label_file = osp.join(root_path, 'label.txt')
skes_name_file = osp.join(root_path, 'skes_available_name.txt')

ske_pkl_path = osp.join(root_path, 'skes_h36m.pkl')


save_path = './data/gast60/'
...
if __name__ == '__main__':
    ...
    setup = np.loadtxt(setup_file, dtype=np.int)  # setup id: 1~32
    ...
    with open(ske_pkl_path, 'rb') as fr:
