...
label_file = './data/gast60/statistics/label.txt'
camera_file = './data/gast60/statistics/camera.txt'
performer_file = './data/gast60/statistics/performer.txt'
skes_name_file = './data/gast60/statistics/skes_available_name.txt'
skes_pkl_file = './data/gast60/statistics/skes_gast.pkl'
